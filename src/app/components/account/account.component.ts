...
export class AccountComponent implements OnInit {
  ...
  //opens interface where user can change their password
  ...
  //opens interface where user can change their name
  openNameDialog(): void {
  ...
  //opens interface where user can change their email
  ...
  //opens interface where user can invite someone to register
