...
// import { BarChart } from './mapbox.model';
...
export class MapboxComponent implements OnInit, AfterViewInit {
  ...
  ngAfterViewInit() {
    ...
    (mapboxgl as typeof mapboxgl).accessToken = 'pk.eyJ1IjoiY2dvbmNhbHZlczA5MSIsImEiOiJjbDdvdjB4NnUxMTgxM29uYjB0djEwYWw4In0.Yazsev1lNiyqs-qyUD6-Pg'
    ...
    map.on('load', ()=> {
      ...
      // const temp = map.getSource('marker');
      // temp.setData(data);
